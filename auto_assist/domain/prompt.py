...
* The markdwon file may not be the profile of the mentioned person. In this case, you should judge whether the markdown file is the profile of the mentioned at the beginning of the input. If the person is not in the chemistry research area, then it is highly possible that the markdown file is not the profile of the mentioned person, in this case, you should return an empty json block.
